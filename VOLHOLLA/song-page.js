(function () {
  ...
  function normalizeAlbumInput(rawValue) {
    ...
    if (raw === "southernnoise" || raw === "southern" || raw === "noise" || raw === "catharsis" || raw === "southern-noise-catharsis" || raw === "southern_noise_catharsis" || raw === "southern noise catharsis" || raw === "snc") {
      return "southernnoise";
    }
    if (raw === "coatvectors" || raw === "coat" || raw === "vectors" || raw === "coat-of-many-vectors" || raw === "coat_of_many_vectors" || raw === "coat of many vectors" || raw === "comv") {
      return "coatvectors";
    }
